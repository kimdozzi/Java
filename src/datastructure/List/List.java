...
public interface List<E> {
     ...
     * List는 ArrayList, SinglyLinkedList, DoublyLinked List에 의해 각각 구현됩니다.
     */
     ...
     * @return 리스트에서 중복을 허용하지 않을 경우에 리스트에 이미 중복되는 요소가 있을 경우 {@code false}를 반환하고, 중복되는 원소가 없을경우 {@code true}를 반환
     */
    boolean add(E value);
